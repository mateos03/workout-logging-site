...
<div class="">
  ...
  <form class="" method="POST" use:enhance={() => {
    ...
    <input class="bg-slate-800 rounded-md w-full text-xl" name="exercise_name" id="exercise_name_input"/>
    <label class="block pt-4 py-2 text-xl" for="exercise_description_input">
      Description:
    </label>
    <textarea class="bg-slate-800 text-2xl w-full rounded-md" name="exercise_description" id="exercise_description_input"></textarea>
